    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-lg-12 margin-tb">
                ...
                <div class="pull-right">
                    <a class="btn btn-success" href="{{ route('create') }}"> Add New Artwork</a>
                </div>
            </div>
        </div>
        ...
        <div class="row mt-3">
            ...
            <div class="col-md-4 mb-4">
                <div class="card">
                    <img src="https://via.placeholder.com/150" class="card-img-top" alt="{{ $artwork->title }}">
                    <div class="card-body">
            ...
            <div class="swiper-wrapper">
                @foreach ($artworks as $artwork)
                    <div class="swiper-slide">
                        <div class="card">
                            <img src="https://via.placeholder.com/150" class="img-fluid rounded-4" alt="{{ $artwork->title }}">
                            <div class="card-body p-0">
                                <a href="single-product.html">
                                    <h3 class="card-title pt-4 m-0">{{ $artwork->title }}</h3>
                                </a>
                                <div class="card-text">
                                    <h3 class="secondary-font text-primary">Price: ${{ number_format($artwork->price, 2) }}</h3>
                                    <h3 class="secondary-font text-primary">Size: {{ $artwork->size }}</h3>
                                    <h3 class="secondary-font text-primary">Medium: {{ $artwork->medium }}</h3>
